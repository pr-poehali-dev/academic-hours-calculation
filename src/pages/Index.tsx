...
const ageGroups = [
  ...
  },
  {
    ...
    emoji: '👦',
    duration: 20,
    description: 'Старший дошкольный возраст. Подготовка к школе с постепенным увеличением продолжительности занятий.',
  ...
  },
  {
    ...
    emoji: '🧑',
    duration: 30,
    description: 'Младший школьный возраст. Стандартный академический час для начальной школы.',
    features: ['Школьная программа', 'Развитие навыков', 'Групповая работа']
  },
  {
    range: '10-14 лет',
    emoji: '👨',
    duration: 40,
    description: 'Средний школьный возраст. Увеличенная продолжительность для более глубокого изучения предметов.',
    features: ['Углубленное обучение', 'Проектная работа', 'Самостоятельность']
  },
  {
    range: '14-18 лет',
    emoji: '🎓',
    duration: 45,
    description: 'Старший школьный возраст. Полноценный академический час как в ВУЗах.',
    features: ['Профориентация', 'Подготовка к ВУЗу', 'Специализация']
  }
];
